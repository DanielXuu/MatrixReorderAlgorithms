...
/** @fileoverview This file defines the Matrix class, instance methods, and static objects/methods.  It depends on the Vector class, but as long as easyload.js is loaded first, Vector.js will automatically be included with this file. */

// dependencies = ['Vector'];
// require(dependencies);

/**Constructor function.  Note that a Matrix object is an Array, where each component is a Vector, representing a row of the matrix.
@requires Vector
@param {Object} elements The elements of the new matrix.  Can either be an Array (one-dimensional, multi-dimensional, or an Array of Vector objects) or a Matrix (in which case it will be cloned into a new one).
@constructor
*/
...
@param {Integer} n the size of the identity matrix to be created
@return {Matrix} an identity matrix of size n x n */
Matrix.I = function(n) {
...
@param {Integer} rows the number of rows for the 0 matrix
@param {Integer} cols the number of columns
@return {Matrix} a rows x cols 0 matrix */
...
@param {Integer} cols the number of columns
@param {Integer} max (Optional) - the maximum value (included) that any element can have; if supplied, all elements will be integers */
